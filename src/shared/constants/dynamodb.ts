...
/**
 * DynamoDB BatchGetItemの最大アイテム数制限
 */
export const DYNAMODB_BATCH_GET_MAX_ITEMS = 100;

/**
 * DynamoDB BatchWriteItemの最大アイテム数制限
 */
export const DYNAMODB_BATCH_WRITE_MAX_ITEMS = 25;

/**
 * DynamoDB Queryの最大結果サイズ（バイト）
 */
export const DYNAMODB_QUERY_MAX_SIZE_BYTES = 1024 * 1024; // 1MB

/**
 * DynamoDB Scanの最大結果サイズ（バイト）
 */
export const DYNAMODB_SCAN_MAX_SIZE_BYTES = 1024 * 1024; // 1MB

/**
 * DynamoDB属性名の予約語
 * 
 * これらの名前は属性名として使用できないため、
